...
objectPose.pose.orientation.x = 0.0
objectPose.pose.orientation.y = 0.0
objectPose.pose.orientation.z = 0.0
...
lift = TwistStamped()
lift.header.frame_id = "robotiq_85_base_link"
...
place.eef_frame = "end_effector_link"
# [initAndConfigSimpleUnGrasp]
...
placeMotion.header.frame_id = "robotiq_85_base_link"
