...
class KinovaMTC : public rclcpp::Node
{
public:
  KinovaMTC() : Node("kinova_mtc")
  {
    // Initialize subscriber
    grasp_pose_subscriber_ = this->create_subscription<geometry_msgs::msg::PoseStamped>(
      "grasp_pose", 10, std::bind(&KinovaMTC::graspPoseCallback, this, std::placeholders::_1));
  }
...
int main(int argc, char **argv)
{
  ...
  auto node = std::make_shared<KinovaMTC>();
  rclcpp::spin(node);
  rclcpp::shutdown();
  return 0;
}